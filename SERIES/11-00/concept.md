...
> **Classic Lo-fi Hip-hop — Dusty, Muffled, Jinsang-style**
>
> Version: 1.1
> Last Updated: 2026-03-07
> Status: 15/15 PASS, YouTube 메타 완료
...
옆자리 사람이 언제 나갔는지 모르고,
커피가 식은 줄도 몰랐다가,
문득 배에서 소리가 나서 고개를 들면,
벌써 점심시간.

Wavvy는 우리말 가사로, 그 몰입의 순간을 기록합니다.
──────────────
Track List

[Loop 1]
🎯 00:00:00 - 01. 경계 (Threshold)
🎯 00:03:29 - 02. 멀어져 (Fade)
🎯 00:05:53 - 03. 리듬 (Rhythm)
🎯 00:08:00 - 04. 에이전트 (Agent)
🎯 00:10:31 - 05. 초점 (Focus)
🎯 00:13:20 - 06. 망각 (Forget)
🎯 00:15:29 - 07. 몰입 (Flow)
🎯 00:18:36 - 08. 하나 (One)
🎯 00:22:08 - 09. 정지 (Freeze)
🎯 00:23:56 - 10. 터널 (Tunnel)
🎯 00:25:59 - 11. 어딘가 (Somewhere)
🎯 00:28:21 - 12. 신호 (Signal)
🎯 00:32:09 - 13. 꼬르륵 (Growl)
🎯 00:34:20 - 14. 고개 (Look Up)
🎯 00:37:55 - 15. 벌써 (Already)

[Loop 2]
🎯 00:40:39 - 01. 경계 (Threshold)
🎯 00:44:08 - 02. 멀어져 (Fade)
🎯 00:46:33 - 03. 리듬 (Rhythm)
🎯 00:48:39 - 04. 에이전트 (Agent)
🎯 00:51:11 - 05. 초점 (Focus)
🎯 00:54:00 - 06. 망각 (Forget)
🎯 00:56:08 - 07. 몰입 (Flow)
🎯 00:59:15 - 08. 하나 (One)
🎯 01:02:47 - 09. 정지 (Freeze)
🎯 01:04:36 - 10. 터널 (Tunnel)
🎯 01:06:39 - 11. 어딘가 (Somewhere)
🎯 01:09:01 - 12. 신호 (Signal)
🎯 01:12:48 - 13. 꼬르륵 (Growl)
🎯 01:15:00 - 14. 고개 (Look Up)
🎯 01:18:34 - 15. 벌써 (Already)
──────────────
...
### 태그 (업로드 시)
```
lofi, classic lofi, jazzhop, lofi hip hop, 로파이, 클래식로파이, 딥워크, 몰입, 집중, 작업용bgm, 집중음악, playlist, 플리, 음악추천, wavvy, 웨이비, 한국어가사, korean lyrics, flow, lofi girl
```
...
| **시간** | 11:00 |
| **Station명** | Flow |
| **감정톤** | 몰입, 무아지경, 시간 왜곡, "엇 벌써?" |
| **장르** | Classic Lo-fi Hip-hop (Jinsang-style) |
| **BPM** | 70-90 |
...
### Flow란?
- **시간 왜곡**: 시간이 빨리/느리게 느껴짐
- **자아 소멸**: 자기 인식 사라짐, 주변 안 들림
- **통제감**: 어렵지만 해낼 수 있는 느낌
- **내적 동기**: 보상 없이도 몰입

### 10-00 vs 11-00

| 구분 | 10-00 (Chillhop) | 11-00 (Classic Lo-fi) |
|------|-----------------|----------------------|
| 단계 | 준비, 시작 | 몰입, Flow |
| 느낌 | "자, 시작하자" | "......" (무아지경) |
| Fidelity | Hi-fi, clean | Lo-fi, dusty |
| BPM | 78-105 | 70-90 |
...
| Lo-fi 특성 | Flow 연결 |
|-----------|----------|
| Dusty/Muffled | 외부 자극 차단 |
| Vinyl crackle | 백색소음처럼 집중 보조 |
| Slow tempo | 느린 호흡, 깊은 상태 |
| Pitch wobble | 시간 왜곡 느낌 |
...
### 필수 요소
- [ ] Vinyl crackle layer (레코드 잡음)
- [ ] Low-pass filter (고음역 롤오프, 8-12kHz)
- [ ] Tape saturation (아날로그 따뜻함 + 미세 압축)
- [ ] Pitch wobble (Wow & Flutter, 몽환적 흔들림)
- [ ] Reverb/delay (공간감, spatial enhancement)
- [ ] Humanized drums (그리드 ±10-20ms 오프셋)
- [ ] Bit crushing (optional, 거친 질감)

### BPM 범위
- Target: 75-85 BPM (sweet spot)
- Min: 70 BPM
- Max: 90 BPM
...
| 파트 | 악기 | 특성 |
|------|------|------|
| **멜로디** | Piano, Rhodes, Guitar | Muffled, distant 처리 |
| **코드** | Jazz voicings | 7th, 9th, 13th chords |
| **베이스** | Deep bass | Warm, muffled |
| **드럼** | Boom-bap | 샘플 또는 드럼머신 |
| **텍스처** | Vinyl noise, ambient pads | 배경 레이어 |
...
- **Humanization**: 그리드에서 ±10-20ms 오프셋 필수

### 금지 요소
- Hi-fi, crisp, clean 프로덕션
- 90+ BPM
- EDM 요소, aggressive drums
- 과도한 에너지 변화
- 4-on-the-floor 킥 패턴
...
### 썸네일
- **색상**: 10-00보다 한 단계 어둡고 따뜻하게
- **효과**: Film grain, vignette (터널 비전)
- **요소**: Wavvy 11:00
- **톤**: Dusty orange, warm brown

### 디자인 토큰
```
Primary:    #D4A574 (dusty orange)
Background: #2A2520 (warm dark brown)
Accent:     #8B7355 (muted caramel)
Grain:      8-12% opacity
```
...
|------|------|------|-------|
| **A** | 4-8줄 한 섹션 | 20% | 2-3곡 |
| **B** | 1-2줄 만트라 반복 | 30% | 4-5곡 |
| **C** | 인스트 + 텍스처 보컬 | **50%** | 6-7곡 |
...
|------|-------|------|------|
| A (4-8줄) | 1곡 | 7% | 15 |
| B (만트라) | 4곡 | 27% | 01, 10, 12, 14 |
| C (인스트) | 10곡 | **67%** | 02, 03, 04, 05, 06, 07, 08, 09, 11, 13 |
