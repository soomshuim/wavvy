...
### 제목
```
[Playlist] [AM 10:00] soomshuim | 조용히 몰입하는 시간, Chillhop
```
...
선명하지만 과하지 않은 비트.
집중을 방해하지 않으면서 곁에 있어주는 Chillhop.

이 플레이리스트의 노래들은 모두 우리말 가사로 만들었습니다.
오늘 오전이 조금 더 차분하게 흘러가길 바라며.
```
...
### 해시태그 (설명란)
```
#chillhop #chillbeats #jazzhop
#lofi #lofibeats
#AM1000 #오전10시 #업무용플레이리스트 #집중음악 #작업용bgm
#한국어가사 #soomshuim
```

### 태그 (업로드 시)
```
chillhop, jazzhop, lofi, 노동요, 집중, 업무플리, 작업용bgm, 집중음악, playlist, 플리, 음악추천, wavvy, 웨이비, 한국어가사
```
