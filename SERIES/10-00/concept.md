...
### 제목
```
Playlist | 10:00 | 조용히 몰입하는 시간 ☕ | CHILLHOP · JAZZHOP | 집중 · 작업 | Wavvy
```

### 설명
```
☕ 10:00, 조용히 몰입하는 시간
하루의 중심에서 차분하게 집중하는 오전 - Wavvy

책상에 앉아 모니터를 켜는 순간부터,
점심 전 허기를 느끼는 시간까지.
까만 화면에 비친 내 얼굴을 보다가,
작업에 잠깐 잠기고, 알림에 고개를 들었다가,
키보드 소리에 리듬이 붙고, 잠시 숨을 고르고,
회의실을 다녀와 다시 자리에 앉고,
열어둔 탭을 하나씩 닫다가,
시계를 바라보며 오전이 끝나는.
...
──────────────
#chillhop #lofi #jazzhop #칠홉 #로파이
#노동요 #집중음악 #작업용bgm #업무플리
...
### 태그 (업로드 시)
```
chillhop, jazzhop, lofi, 칠홉, 노동요, 집중, 업무플리, 작업용bgm, 집중음악, playlist, 플리, 음악추천, wavvy, 웨이비, 한국어가사, korean lyrics, AM1000, 오전10시
```
...
---
#chillhop #업무용음악 #집중 #playlist #wavvy
