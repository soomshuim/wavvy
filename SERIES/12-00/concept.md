...
| 분위기 | Groovy, Uplifting, Midday energy |
...
점심 직전, 배가 고프지만 기분 좋은 시간.
일에서 잠시 벗어나 음식을 기다리는 설렘.
신나지만 공격적이지 않은, groovy한 에너지.
...
full Amapiano, log drum dominant,
dark, melancholic, slow tempo
```
...
## YouTube Draft (v1 — 트랙 미완성)

### 제목
```
Playlist | 12:00 | 배고픈 점심의 그루브 🍽️ | K-AFRO NEO-SOUL | 점심 · 카페 | Wavvy
```

### 설명
```
🍽️ 12:00, 배가 고파지는 시간.
그루브 위로 점심을 기다려요. - Wavvy
...
### 태그
```
k-afro neo-soul, afro neo soul, korean afro, 점심플리,
아프로네오소울, 점심음악, 카페음악, groovy playlist,
wavvy, 웨이비, korean lyrics, 한국어가사
```
...
- Tyla "Water" (117 BPM, Ebm) - Amapiano 트렌드
- FKJ / Tom Misch - Neo-Soul 그루브
- 사용자 테스트 곡 (98 BPM, Rhodes, African percussion)
