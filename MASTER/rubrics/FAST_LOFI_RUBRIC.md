...
운영 범위 110-150은 다음 이유로 설정한다:
- 하한 110: 워밍업/안정 구간 확보
- 중심 122-128: 추진력과 lo-fi 질감의 균형점
- 상한 150: 피크 트랙 허용 (EDM화 방지는 장르 경계 팩터에서 관리)
...
| 14-17 | BPM 110-150 범위 준수, 일부 구간 추진력 약화 |
...
```
□ BPM 110-150, 중심 122-128로 유지된다 (피크 트랙 140-150 허용)
□ 킥/스네어/하이햇이 추진력을 만든다
...
- 2026-02-16: v1.3 BPM 상한 확장 (130 → 150, 피크 트랙 허용)
